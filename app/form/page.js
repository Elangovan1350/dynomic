    ...
    <div className="min-h-screen flex justify-center items-center">
      <div className="w-5/6 h-fit bg-slate-600 p-40">
        <form action="" className="flex flex-col gap-5">
          ...
          <input type="text" name="category" placeholder="category" onChange={handleInput} />
          <input type="number" name="count" placeholder="count" onChange={handleInput} />
          <input type="number" name="rate" placeholder="rate" onChange={handleInput} />
          <button onClick={sendData} className="text-2xl font-bold bg-blue-400 px-10 py-3 mb-10 rounded-lg">Save</button>
